...
const HeroSection = () => {
  ...
  const heroVideos = [
    {
      id: 1,
      src: "/assets/4178111-hd_1920_1080_30fps.mp4",
      title: "Domina el trabajo con tijeras",
    },
    {
      id: 2,
      src: "/assets/5483574-hd_1920_1080_30fps.mp4",
      title: "Precisión de Navaja Recta",
    },
    {
      id: 3,
      src: "/assets/7686590-hd_1920_1080_24fps.mp4",
  ...
  return (
    <section className="relative h-auto w-full overflow-hidden pb-10">
      {/* Video Background */}
      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mt-[4rem] max-w-4xl">
            ...
            >
              Más que una barbería, un lugar para relajarte, renovarte y llevar
            ...
            >
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://www.facebook.com/tuyyospqs/photos",
                    "_blank",
                  )
                }
              >
      ...
      >
        <div className="flex flex-col items-center">
          <span className="text-sm font-body mb-2 rotate-90 origin-center">
            Scroll
          </span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
